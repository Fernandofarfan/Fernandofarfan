...
![Google AppScript](https://img.shields.io/badge/Google_AppScript-4285F4?style=for-the-badge&logo=google&logoColor=white)
...
<div align="center">
  <img height="180em" src="https://fernandofarfan-stats.vercel.app/api?username=fernandofarfan&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true"/>
  <img height="180em" src="https://fernandofarfan-stats.vercel.app/api/top-langs/?username=fernandofarfan&layout=compact&langs_count=8&theme=tokyonight"/>
</div>
...
Universidad Tecnológica Nacional (UTN) | *2do Año en curso*  
Formación técnica en desarrollo de software, arquitectura de sistemas, bases de datos y metodologías ágiles.

**Licenciatura en Relaciones del Trabajo**  
Universidad de Buenos Aires (UBA) | *5to Año*  
Formación en gestión de recursos humanos, derecho laboral y administración organizacional.

---

## 🌟 Habilidades Destacadas

- ✅ **Desarrollo Full Stack** con React, Vue.js, Node.js, Java, Python y .NET
- ✅ **Administración de Bases de Datos** (SQL Server, PostgreSQL, MySQL, MongoDB)
- ✅ **DevOps & CI/CD** con Docker, Kubernetes, Jenkins y GitHub Actions
- ✅ **Análisis de Datos** con Power BI, Python (Pandas, NumPy) y SQL avanzado
- ✅ **Automatización** con PowerShell, Bash, Python Scripts y Power Automate
- ✅ **Metodologías Ágiles** (Scrum, Kanban)
- ✅ **Testing & QA** (TDD, BDD, API Testing con Postman)
